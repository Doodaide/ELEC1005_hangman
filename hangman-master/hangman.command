...
def random_word():
    if difficulty == "easy":
        words = [line.strip() for line in open("Desktop/semester1/ELEC1005/week3/hangman-master/words/"+word_file) if (len(line) < 6 and len(line) <= 5)]
    elif difficulty == "hard":
        words = [line.strip() for line in open("Desktop/semester1/ELEC1005/week3/hangman-master/words/"+word_file) if len(line) > 5]
...
# Music
def playmusic():
    filepath = "Desktop/semester1/ELEC1005/week3/hangman-master/Back_In_Black.mp3"
    pygame.mixer.init()
